...
The beetles experienced a shift in diet and environment and this affected the bacterial composition of their microbiome (R2 = .21, F= 2.95 df = 1, p = 0.005). Sampling location (gut vs exterior) was not a significant predictor of the bacterial composition (R2 = 0.08, F = 1.16 df = 1, p = 0.328), nor was their interaction (R2 = 0.09, F = 1.35, p = 0.193).
...
Composition of the bacterial communities is primarily driven by extraction location (R2 = 0.12, F = 8.02, df = 1, p = 0.001), but drench is also a key predictor of bacterial composition (R2 = 0.04, F = 2.65, df = 1, p = 0.005). (\*No ellipse is calculated for the control gut samples, due to too few points.) Their interaction was not a significant predictor of bacterial composition (R2 = 0.02, F = 1.42, df = 1, p = 0.121).
