...
diet_composition_PCoA <- plot_ordination(DATA_diet, ord, color = "Extraction_final", shape = "Treatment") +
  geom_point(size = 3)+
...
```{r, warning=FALSE, message=FALSE}
# check for differences in concentration for each of the parasiticides
